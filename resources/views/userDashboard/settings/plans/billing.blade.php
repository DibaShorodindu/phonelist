...
<section class="section-main">
    ...
    <section class="second-navbar">
        <ul class="nav nav-tabs">
            <li class="nav-item">
                <a href="{{ route('managePlan') }}" class="nav-link">Plan Overview</a>
            </li>
            <li class="nav-item">
                <a href="{{ route('billing') }}" class="nav-link active">Billing</a>
            </li>
        </ul>
    </section>
    <!-- END SECOND NAVBAR -->
                    ...
                    <div class="card p-4 border-0 rounded-3">
                        <div class="card-title m-0 d-flex justify-content-between align-items-center  col-12">
                            ...
                            <div class="col-7">
                                ...
                                <button type="button" class="btn btn-purple text-white col-6">
                        ...
                        <div class="card-body text-secondary d-none">
